...
assert.match(source, /Local CLI only \(no account; enable remote later\)/, "setup must offer an account-free path");
assert.match(source, /syncChoice === "l"/, "local choice must bypass relay enrollment");
