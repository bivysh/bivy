...
const fixtures = {
  draft: `
    <div class="app review-fixture">
      <aside class="sidebar"><div class="sidebar-head"><strong class="brand">Bivy</strong></div><nav class="session-list"><button class="session-item active"><span class="session-body"><span class="session-title-row"><span class="session-name">New session</span></span><span class="session-meta">Draft</span></span></button></nav><div class="sidebar-foot"><button class="btn primary new-session-btn"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"></path><path d="M16.4 3.6a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z"></path></svg><span>New session</span></button><button class="btn icon settings-gear" aria-label="Settings"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="12" cy="12" r="3"></circle><path d="M12 2v3M12 19v3M4.9 4.9 7 7M17 17l2.1 2.1M2 12h3M19 12h3M4.9 19.1 7 17M17 7l2.1-2.1"></path></svg></button></div></aside>
  ...
  live: `
    <div class="app review-fixture">
      <aside class="sidebar">
        <div class="sidebar-head"><strong class="brand">Bivy</strong></div>
        <div class="session-list"><nav class="sidebar-nav" aria-label="Workspace"><button class="sidebar-nav-item"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M13 2 3 14h9l-1 8 10-12h-9z"></path></svg><span>Automations</span></button><button class="sidebar-nav-item" aria-label="Open standalone terminal"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="4" width="18" height="16" rx="2"></rect><path d="m7 9 3 3-3 3M13 15h4"></path></svg><span>Terminal</span></button></nav><div class="session-list-tools"><label class="session-search-wrap"><svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="7"></circle><path d="m21 21-4.3-4.3"></path></svg><input class="field session-search" type="search" aria-label="Search sessions" placeholder="Search 3 sessions"></label><button class="session-filter-btn" aria-label="Filter sessions">≡</button></div><button class="session-item active"><span class="session-body"><span class="session-title-row"><span class="row-status"><span class="status-dot" data-status="working"></span></span><span class="session-name">Improve onboarding</span><span class="session-age">now</span></span><span class="session-meta">Pi · Mac Studio</span></span></button><button class="session-item"><span class="session-body"><span class="session-title-row"><span class="session-name">Review authentication flow</span><span class="session-age">18m</span></span><span class="session-meta">Codex · Mac Studio</span></span></button><button class="session-item"><span class="session-body"><span class="session-title-row"><span class="session-name">Fix mobile viewport</span><span class="session-age">1d</span></span><span class="session-meta">Claude Code</span></span></button></div>
        <div class="sidebar-foot"><button class="btn primary new-session-btn"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"></path><path d="M16.4 3.6a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z"></path></svg><span>New session</span></button><button class="btn icon settings-gear" aria-label="Settings"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="12" cy="12" r="3"></circle><path d="M12 2v3M12 19v3M4.9 4.9 7 7M17 17l2.1 2.1M2 12h3M19 12h3M4.9 19.1 7 17M17 7l2.1-2.1"></path></svg></button></div>
      </aside>
      <main class="main">
        <header class="topbar"><button class="btn ghost icon only-mobile" aria-label="Open navigation">☰</button><div class="topbar-title"><div class="topbar-title-row"><h1 class="title">Improve onboarding</h1></div><span>Pi on Mac Studio</span></div><div class="topbar-actions"><button class="btn ghost focus-view-btn" aria-label="Show only prompts and final answers" aria-pressed="false"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7z"></path><circle cx="12" cy="12" r="3"></circle></svg><span class="focus-view-label">Focus</span></button><button class="btn ghost icon" aria-label="Session menu">⋯</button></div></header>
        <div class="chat-wrap"><div class="chat"><div class="chat-inner">
          <div class="transcript-turn">
            ...
            <div class="turn-response-body">
              ...
              <div class="tool-group"><button class="tool-group-line" aria-label="Worked: Reviewed four files. Open work details"><span class="tool-group-label">Worked</span><span class="tool-group-summary">Reviewed four files</span><span class="tool-chevron">›</span></button></div>
              <div class="assistant-row"><div class="msg assistant"><p>The hierarchy is in place. I’m checking the working and completed states now.</p></div></div>
              <div class="tool-group"><button class="tool-group-line" aria-label="Worked: Updated three files and ran checks. Open work details"><span class="tool-group-label">Worked</span><span class="tool-group-summary">Updated three files and ran checks</span><span class="tool-chevron">›</span></button></div>
...
test("interim message and continuing work are reviewable in both themes", async ({ page }, testInfo) => {
  for (const theme of THEMES) {
    await page.evaluate(({ html, selectedTheme }) => {
      ...
      replies[1]?.remove();
      replies[2]?.remove();
      const work = Array.from(document.querySelectorAll(".tool-group-line")).at(-1)!;
      work.classList.add("is-running");
      work.querySelector(".tool-group-label")!.textContent = "Working";
      work.querySelector(".tool-group-summary")!.textContent = "Running final checks…";
      work.insertAdjacentHTML("afterbegin", '<span class="tool-group-state" aria-hidden="true"></span>');
...
test("focus view keeps only prompts and final answers", async ({ page }, testInfo) => {
  for (const theme of THEMES) {
    await page.evaluate(({ html, selectedTheme }) => {
      document.documentElement.dataset.theme = selectedTheme;
      document.body.innerHTML = html;
      const replies = Array.from(document.querySelectorAll(".turn-response-body > .assistant-row"));
      replies.slice(0, -1).forEach((reply) => reply.remove());
      document.querySelectorAll(".tool-group").forEach((group) => group.remove());
      ...
      document.querySelector(".session-item.active .row-status")!.remove();
      const send = document.querySelector(".composer-btn")!;
      send.className = "composer-btn send";
      send.setAttribute("aria-label", "Send message");
      send.innerHTML = '<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M12 19V5"></path><path d="m5 12 7-7 7 7"></path></svg>';
    }, { html: fixtures.live, selectedTheme: theme });
    await assertNamedControls(page);
