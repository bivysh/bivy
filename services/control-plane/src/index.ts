...
app.post("/account/automations", asyncHandler(async (req, res) => {
  ...
  const definition = await store.createAutomationDefinition(client.accountId, {
    ...
    approvalMode: ["ask", "autonomous", "never"].includes(req.body?.approvalMode) ? req.body.approvalMode : undefined,
...
app.put("/account/automations/:id", asyncHandler(async (req, res) => {
  ...
  const patch = {
    ...
    approvalMode: ["ask", "autonomous", "never"].includes(req.body?.approvalMode) ? req.body.approvalMode : current.approvalMode,
