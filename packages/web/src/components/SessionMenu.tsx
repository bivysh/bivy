...
/**
 * Header dot-menu for the active session: rename, fork/move, delete, plus
 * "Update GitHub status" (repo sessions) to re-check the PR state on demand.
 * An inline popover anchored to the header — the header isn't a scroll
 * container, so it doesn't need the bottom-sheet escape hatch that the list
 * row does.
 */
