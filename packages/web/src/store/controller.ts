...
export class AppController {
  ...
  async appCommand(command: "apps.list" | "apps.offers" | "apps.adopt" | "apps.open" | "apps.logs" | "apps.share" | "apps.revoke" | "apps.remove", sessionId: string, fields: { appId?: string; viewId?: string; returnTo?: string; port?: number; direct?: boolean } = {}): Promise<ServerEvent> {
